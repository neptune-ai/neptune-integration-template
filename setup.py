...
def main():
    ...
    setup(
        name="neptune-{{ short_name }}",
        version=version,
        description="Neptune.ai {{ full_name }} integration library",
        author="neptune.ai",
        ...
        project_urls={
            "Tracker": "https://github.com/neptune-ai/{{ package_directory }}/issues",
            "Source": "https://github.com/neptune-ai/{{ package_directory }}",
